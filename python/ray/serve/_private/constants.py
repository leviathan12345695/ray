...
# The idle timeout for flushing buffered request path logs. Disabled by default
# to preserve the existing MemoryHandler behavior unless users explicitly opt in.
RAY_SERVE_REQUEST_PATH_LOG_FLUSH_TIMEOUT_S = get_env_float_non_negative(
    "RAY_SERVE_REQUEST_PATH_LOG_FLUSH_TIMEOUT_S", 0
)
